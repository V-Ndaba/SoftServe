...
const CreateGraduate = () => {
    ...
    const handleAddGraduate = () => {
        ...
        fetch('https://localhost:7172/Graduate/CreateGraduate',{
            ...
            body: JSON.stringify({
                "graduateID": "3fa85f64-5717-4562-b3fc-2c963f66afa6",
                "firstName": name,
                "lastName": surname,
                "emailAddress": email,
                "dateOfBirth": dateofbirth,
                "age": contact,
                "dateCreated": `${current.getFullYear()}/${current.getMonth()+1}/${current.getDate()}`,
                "isDeleted": false
            })
        })
        .then((result) => {
        ...
        <div>
            ...
            <form className="absolute bottom-1/4 left-1/2 transform -translate-x-1/2 w-3/4">
                <div className="flex flex-wrap gap-y-8 gap-x-8 justify-between">
                    ...
                    <div className="w-full md:w-[48%] flex flex-col">
                        <button className="absolute flex bg-red text-white mx-8 ps-5 rounded-xl text-lg micro-5" onClick={handleAddGraduate} >
                            ADD NEW GRADUATE
